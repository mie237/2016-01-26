...
**Table 2:** $\sum_{i=1}^4 \frac{\left(O_i - E_i\right)^2}{E_i} = 10^2/40 + 10^2/40 + 10^2/10 + 10^2/10 = `r sum(10^2/c(40, 40, 10, 10))`$ and the p-value is $P\left(\chi^2_1 \ge 0\right) =  `r round(1-pchisq(sum(10^2/c(40, 40, 10, 10)), 1), 3)`$

**Table 3:** $\sum_{i=1}^4 \frac{\left(O_i - E_i\right)^2}{E_i} = 1^2/40 + 1^2/40 + 1^2/10 + 1^2/10 = `r sum(1^2/c(40, 40, 10, 10))`$ and the p-value is $P\left(\chi^2_1 \ge 0\right) =  `r round(1-pchisq(sum(1^2/c(40, 40, 10, 10)), 1), 3)`$

**Table 4:** $\sum_{i=1}^4 \frac{\left(O_i - E_i\right)^2}{E_i} = 4^2/40 + 4^2/40 + 4^2/10 + 4^2/10 = `r sum(4^2/c(40, 40, 10, 10))`$ and the p-value is $P\left(\chi^2_1 \ge 0\right) =  `r round(1-pchisq(sum(4^2/c(40, 40, 10, 10)), 1), 3)`$
